...
При добавлении `EventBus` корневой модуль должен:
...
EventBus должен добавлять событие в EventStore до публикации в шину. 
Атомарная связь append и публикации пока не реализована; это ограничение определено в `docs/ARCHITECTURE.md`.
