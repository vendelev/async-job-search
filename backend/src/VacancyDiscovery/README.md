...
Источники выполняются конкурентно группами до трёх. 
После успешного завершения источника use case записывает в logger его класс и количество полученных вакансий до 
дедупликации. Ошибка одного источника записывается в logger после завершения его группы и не отменяет остальные 
источники этой группы.
...
600 секунд и повторяет цикл. 
Он записывает в журнал запуск и остановку daemon, а также начало и успешное завершение каждого поиска. 
